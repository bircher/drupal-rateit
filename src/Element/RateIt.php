...
namespace Drupal\rateit\Element;

use Drupal\Core\Render\Element\Range;
use Drupal\Core\Render\Element;

/**
 * Provides a form element that uses rateit.
 *
 * @FormElement("rateit")
 */
class RateIt extends Range {
  ...
  /**
   * Prepares a #type 'rateit' render element for input.html.twig.
   *
   * @param array $element
   ...
   */
  public static function preRenderRateit(array $element) {
    $element['#attributes']['type'] = 'range';
    Element::setAttributes($element, ['id', 'name', 'value', 'step', 'min', 'max']);
    static::setAttributes($element, ['form-rateit']);
